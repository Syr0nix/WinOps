...
cls
echo ====================================================
echo Windows Fix and Boosters Menu
echo ====================================================
...
echo [24] Restore Location Services
echo [25] install 7zip.exe
echo [26] install winrar.exe
...
:proc24
:: Batch script to enable location services globally

echo Enabling location services for all users and apps...

:: Enable location services system-wide
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors" /v "DisableLocation" /t REG_DWORD /d 0 /f

:: Apply the changes
echo Applying changes...
gpupdate /force

echo Location services have been enabled globally.
...
:: Batch script to disable location services globally

echo Disabling location services for all users and apps...
...
echo Location services have been disabled globally.
